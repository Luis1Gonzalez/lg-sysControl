...
export default function AddSerieModal({ modalAddSerie, setModalAddSerie }) {
  const {
    setNumSerie,
    numSerie,
    setPrimalSerie,
  ...
  return (
    <Transition.Root show={modalAddSerie} as={Fragment}>
      <Dialog
        as="div"
        className="fixed z-10 inset-0 overflow-y-auto"
        onClose={() => setModalAddSerie(false)}
      >
            ...
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start">
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <form onSubmit={newSerie} className="my-10">
                    {/* ------------------------------Serie---------------------- */}
                    <div className="mb-5">
                      <label
                        htmlFor="num-serie"
                      ...
                      <input
                        type="text"
                        id="num-serie"
                        onChange={(e) => setPrimalSerie(e.target.value)}
                        value={numSerie}
                        placeholder="ej.: H0002"
                        pattern="[A-Z][0-9]+"
